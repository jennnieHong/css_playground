  ...
  const menuStructure = [
    {
      ...
      children: [
        ...
        { title: '9. Reference Types', path: '/js/reference-types', icon: '🧠', order: 9 },
        { title: '10. Array-like Objects', path: '/js/array-like', icon: '🎭', order: 10 },
        { title: '11. Functions & Closures', path: '/js/functions', icon: '🧩', order: 11 },
        { title: '12. Arrays Mastery', path: '/js/arrays', icon: '📊', order: 12 },
        { title: '13. Objects & Props', path: '/js/objects', icon: '🗃️', order: 13 },
        { title: '14. DOM Manipulation', path: '/js/dom-manipulation', icon: '🖱️', order: 14 },
        { title: '15. Event Handling', path: '/js/events', icon: '⚡', order: 15 },
        { title: '16. Async Basics', path: '/js/async-basics', icon: '⏳', order: 16 },
        { title: '17. Fetch & APIs', path: '/js/async-fetch', icon: '🌐', order: 17 },
        { title: '18. ES6+ Modern', path: '/js/modern', icon: '🚀', order: 18 },
        { title: '19. Number Precision', path: '/js/precision', icon: '🎯', order: 19 },
        { title: '20. Type Determination', path: '/js/type-checking', icon: '🔍', order: 20 },
        { title: '21. Prototypes', path: '/js/prototypes', icon: '🧬', order: 21 },
      ]
    }
  ];
